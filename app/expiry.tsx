...
const styles=StyleSheet.create({
  safeArea:{flex:1,backgroundColor:'#F6F8FC'},container:{padding:24,gap:18,maxWidth:1100,width:'100%',alignSelf:'center'},headerRow:{flexDirection:'row',gap:12,alignItems:'center'},grow:{flex:1},title:{fontSize:28,fontWeight:'800',color:'#102A5C'},subtitle:{color:'#667085',marginTop:4},label:{fontSize:13,fontWeight:'700',color:'#475467'},meta:{color:'#667085',fontSize:13},error:{color:'#B42318'},card:{backgroundColor:'#FFF',borderRadius:16,padding:18,gap:12},sectionTitle:{fontSize:20,fontWeight:'700',color:'#102A5C'},metricGrid:{flexDirection:'row',flexWrap:'wrap',gap:10},metric:{backgroundColor:'#FFF',borderRadius:14,padding:14,minWidth:130},metricValue:{fontSize:20,fontWeight:'800',color:'#102A5C'},chips:{flexDirection:'row',flexWrap:'wrap',gap:8},chip:{borderWidth:1,borderColor:'#D0D5DD',borderRadius:999,paddingVertical:8,paddingHorizontal:12},chipSelected:{backgroundColor:'#102A5C',borderColor:'#102A5C'},chipText:{fontSize:13,fontWeight:'600',color:'#344054'},chipTextSelected:{color:'#FFF'},riskRow:{flexDirection:'row',alignItems:'center',gap:12,padding:12,borderRadius:10,borderWidth:1,borderColor:'#EAECF0'},riskRowSelected:{borderColor:'#102A5C',backgroundColor:'#F4F7FC'},name:{fontWeight:'700',color:'#101828'},quantity:{fontWeight:'800',fontSize:18,color:'#101828',textAlign:'right'},input:{borderWidth:1,borderColor:'#D0D5DD',borderRadius:10,padding:11,color:'#101828'},smallInput:{width:150,borderWidth:1,borderColor:'#D0D5DD',borderRadius:10,padding:10},actions:{flexDirection:'row',flexWrap:'wrap',gap:8},returnRow:{flexDirection:'row',gap:8,alignItems:'center'},alertRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:12,paddingVertical:10,borderBottomWidth:1,borderBottomColor:'#EAECF0'},primaryButton:{alignSelf:'flex-start',backgroundColor:'#102A5C',borderRadius:10,paddingVertical:11,paddingHorizontal:16},primaryButtonText:{color:'#FFF',fontWeight:'700'},secondaryButton:{alignSelf:'flex-start',borderWidth:1,borderColor:'#98A2B3',borderRadius:10,paddingVertical:10,paddingHorizontal:14},secondaryButtonText:{color:'#344054',fontWeight:'700'},dangerButton:{alignSelf:'flex-start',borderWidth:1,borderColor:'#B42318',borderRadius:10,paddingVertical:10,paddingHorizontal:14},dangerConfirm:{backgroundColor:'#B42318'},dangerText:{color:'#B42318',fontWeight:'700'},disabled:{opacity:.45}
});
